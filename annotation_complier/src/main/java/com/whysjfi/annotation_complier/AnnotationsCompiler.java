package com.whysjfi.annotation_complier;
...
//        types.add(Override.class.getCanonicalName());
    ...
    public synchronized void init(ProcessingEnvironment processingEnvironment) {
        ...
        processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE,"11111111111111111---------------");
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE,"666666666666666jett---------------"+set);
...
//          VariableElement//属性
        ...
        processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE,"why fklsadkflsda ________"+set);
